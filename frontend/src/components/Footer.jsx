function Footer (){
    return (
        <>
            <footer className='flex flex-col justify-end bg-black pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden w-ful mt-12'>
                <div className='w-full max-w-7xl mx-auto'>
                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                        ...
                        <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-start text-left">
                            ...
                            <p className='text-sm text-white/60 mt-6 max-w-[350px] leading-relaxed'>GymFlow is a growing management portal of premium, flexible fitness memberships. Every subscription tier undergoes an optimization check to deliver production-ready, high-performance training features straight to your member profile at unbeatable prices.</p>
                        </div>
